...
namespace Findgroup_Backend.CompiledModels
{
    internal partial class IdentityUserLoginEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            loginProvider.TypeMapping = MySqlStringTypeMapping.Default.Clone(
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    ...
                    size: 255));
            loginProvider.AddAnnotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.None);
            ...
            var providerKey = runtimeEntityType.AddProperty(
                ...
                afterSaveBehavior: PropertySaveBehavior.Throw);
            providerKey.TypeMapping = MySqlStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    (string v1, string v2) => v1 == v2,
                    (string v) => v.GetHashCode(),
                    (string v) => v),
                ...
                mappingInfo: new RelationalTypeMappingInfo(
                    storeTypeName: "varchar(255)",
                    size: 255));
            providerKey.AddAnnotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.None);
            ...
            var providerDisplayName = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            providerDisplayName.TypeMapping = MySqlStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    (string v1, string v2) => v1 == v2,
                    (string v) => v.GetHashCode(),
                    (string v) => v),
            ...
            providerDisplayName.AddAnnotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.None);
            ...
            userId.TypeMapping = MySqlStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    (string v1, string v2) => v1 == v2,
                    (string v) => v.GetHashCode(),
                    (string v) => v),
