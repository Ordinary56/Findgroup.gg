...
namespace Findgroup_Backend.Controllers
{
    ...
    public sealed class GroupController(IGroupRepository groupRepo, IUserRepository userRepo) : ControllerBase
    {
        ...
        [HttpPost("create")]
        public async Task<ActionResult> CreateNewGroup([FromQuery] string name, [FromQuery] int memberLimit, [FromQuery] string userId)
        {
            ...
            await _groupRepository.CreateNewGroup(name, memberLimit, creator);
